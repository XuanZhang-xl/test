...
最常用也是最复杂的callback, 会生成三个class, 一个代理类, 两个fastclass, 作为索引
...
private static final Method CGLIB$listUser$1$Method;
private static final MethodProxy CGLIB$listUser$1$Proxy;
...
static void CGLIB$STATICHOOK1() {
    ...
    var10000 = ReflectUtils.findMethods(new String[]{"save", "(Lxl/test/common/entity/User;)V", "listUser", "()Ljava/util/List;"}, (var1 = Class.forName("xl.test.framework.springboot.aop.proxy.UserServiceForAopImpl")).getDeclaredMethods());
    ...
    CGLIB$listUser$1$Method = var10000[1];
    CGLIB$listUser$1$Proxy = MethodProxy.create(var1, var0, "()Ljava/util/List;", "listUser", "CGLIB$listUser$1");
}
public final void save(User var1) {
...
```
这么调用是因为其能直接调用被代理的方法, 而不是反射调用, 速度比反射调用快, 那么, 为什么这么调用要比反射快呢?
