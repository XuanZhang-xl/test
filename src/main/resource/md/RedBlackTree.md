...
![图2 结点叫法约定](../img/redblacktree/节点叫法约定.png)
...
![图10 插入情景4.1_2](../img/redblacktree/插入情景4.1_2.png)
...
![图20 删除操作结点的叫法约定](../img/redblacktree/删除操作结点的叫法约定.png)
...
![图26 删除情景2.2.2.1](../img/redblacktree/删除情景2.2.2.1.png)
