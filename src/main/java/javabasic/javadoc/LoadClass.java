...
public class LoadClass {
    ...
    public static void main(String[] args) throws MalformedURLException, ClassNotFoundException {
        ...
        //获取路径classes的路径
        String classPath = "C:\\Users\\zhangxuan9\\IdeaProjects\\test\\src\\main\\java\\javabasic.javadoc\\StaticProperty.java";
        String prefix = classPath.substring(0,classPath.indexOf("classes")+8);
        //这里得到的就是com.company.base.controller包的全名
        String className = "javabasic.javadoc.StaticProperty";

        URL classes = new URL("javabasic.javadoc:///"+prefix);
